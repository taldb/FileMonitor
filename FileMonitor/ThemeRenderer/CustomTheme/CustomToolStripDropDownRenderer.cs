...
public class CustomToolStripDropDownRendererC : ToolStripProfessionalRenderer
{
    protected override void OnRenderToolStripBackground(ToolStripRenderEventArgs e)
    {
        // Define your custom background color
        Color bgColor = ColorTranslator.FromHtml(vars.ToolStripBackground1); // Dark gray
    ...
    protected override void OnRenderMenuItemBackground(ToolStripItemRenderEventArgs e)
    {
        ...
        {
            // Define your custom background color
            Color bgColor = ColorTranslator.FromHtml(vars.MenuItemBackground); // Dark gray
