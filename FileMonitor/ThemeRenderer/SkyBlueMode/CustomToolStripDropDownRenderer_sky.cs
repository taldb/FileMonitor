...
namespace FileMonitor.ThemeRenderer.SkyBlueMode
{
    /*
    Usage:
    ...
    */
    ...
    public class CustomToolStripDropDownRenderer_skyMode : ToolStripProfessionalRenderer
    {
        protected override void OnRenderToolStripBackground(ToolStripRenderEventArgs e)
        {
            // Define your custom background color
            Color bgColor = ColorTranslator.FromHtml("#99cbec");
